				...
				if (gameMembers.get(i) != null) {
					if (Boundary.isIn(gameMembers.get(i), GAME_BOUNDARY)) {
						...
						if (player.pestControlDamage > MINIMUM_DAMAGE) {
							...
							int point_reward = DoubleMinigames.isDoubleMinigames() && Config.BONUS_MINIGAME_WOGW ? 55 :
											   !DoubleMinigames.isDoubleMinigames() && Config.BONUS_MINIGAME_WOGW ? 30 : 
												   DoubleMinigames.isDoubleMinigames() && !Config.BONUS_MINIGAME_WOGW ? 50 : POINT_REWARD;
