...
public class PlayerSave {
			...
			if (spot > -1) {
				...
				case 2:
					if (token.equals("character-height")) {
						...
						p.teleportToX = (Integer.parseInt(token2) <= 0 ? 3104 : Integer.parseInt(token2));
					} else if (token.equals("character-posy")) {
						p.teleportToY = (Integer.parseInt(token2) <= 0 ? 3500 : Integer.parseInt(token2));
					...
					} else if (token.equals("rigUnlocked")) {
						p.rigUnlocked = Boolean.parseBoolean(token2);
				} else if (token.equals("augUnlocked")) {
						p.augUnlocked = Boolean.parseBoolean(token2);
				} else if (token.equals("absorptionToggle")) {
					p.absorptionToggle = Boolean.parseBoolean(token2);
					...
					}else if (token.equals("dailyPoints")) {
						p.dailyPoints = (Integer.parseInt(token2));
					...
					} else if (token.equals("tobCount")) {
						p.tobCount = (Integer.parseInt(token2));
					...
					} else if (token.equals("sanguinesti-staff")) {
					...
					} else if (token.equals("ether-charge")) {
						p.setEtherCharge(Integer.parseInt(token2));
					} else if (token.equals("craw-charge")) {
						p.setCrawCharge(Integer.parseInt(token2));
					} else if (token.equals("vig-charge")) {
						p.setVigCharge(Integer.parseInt(token2));
					} else if (token.equals("sceptre-charge")) {
						p.setSceptreCharge(Integer.parseInt(token2));
					...
					} else if (token.equals("slayer-pets")) {
						p.getSlayer().setSlayerPetSpawns(Boolean.parseBoolean(token2));
					...
					} else if (token.equals("bonus-drop-time")) {
						p.bonusDropTime = Long.parseLong(token2);
	...
	public static boolean saveGame(Player p) {
		...
		try {
			...
			characterfile.newLine();
			characterfile.write("rigUnlocked = " + p.rigUnlocked);
			characterfile.newLine();
			characterfile.write("augUnlocked = " + p.augUnlocked);
			characterfile.newLine();
			characterfile.write("absorptionToggle = " + p.absorptionToggle);
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("dailyPoints = " + p.dailyPoints);
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("tobCount = " + p.tobCount);
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("slayer-pets = " + p.getSlayer().isSlayerPetSpawns());
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("sanguinesti-staff = " + p.getSangStaffCharge());
			characterfile.newLine();
			characterfile.write("arclight-charge = " + p.getArcLightCharge());
			characterfile.newLine();
			characterfile.write("ether-charge = " + p.getEtherCharge());
			characterfile.newLine();
			characterfile.write("craw-charge = " + p.getCrawCharge());
			characterfile.newLine();
			characterfile.write("vig-charge = " + p.getVigCharge());
			characterfile.newLine();
			characterfile.write("sceptre-charge = " + p.getSceptreCharge());
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("bonus-drop-time = ", 0, 18);
			characterfile.write(Long.toString(p.bonusDropTime), 0, Long.toString(p.bonusDropTime).length());
			characterfile.newLine();
