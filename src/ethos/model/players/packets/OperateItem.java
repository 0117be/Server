...
public class OperateItem implements PacketType {
	...
	public void processPacket(Player c, int packetType, int packetSize) {
		...
		if(c.getRights().isOrInherits(Right.OWNER) || c.getRights().isOrInherits(Right.MANAGER)) {
			...
			switch (itemId) {
			case 22121://Wrath Tiara
				c.getPA().movePlayer(2335, 4827);
				break;
			case 9948:
			case 9949:
			...
			break;
			case 21816:
				c.sendMessage("Your Bracelet has "+ c.getEtherCharge() +" charges remaining.");
			break;
			case 22550:
				c.sendMessage("Your Bow has "+ c.getCrawCharge() +" charges remaining.");
			break;
			case 22555:
				c.sendMessage("Your Sceptre has "+ c.getSceptreCharge() +" charges remaining.");
			break;
			case 22545:
				c.sendMessage("Your Chainmace has "+ c.getVigCharge() +" charges remaining.");
			break;
			case 22323:
