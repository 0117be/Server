	...
	public void execute(Player c, String input) {
		...
		for (int i = 0; i < PlayerHandler.players.length; i++) {
			if (PlayerHandler.players[i] != null) {
				...
				if (c2.getRights().isOrInherits(Right.HELPER) || c2.getRights().isOrInherits(Right.MODERATOR) || c2.getRights().isOrInherits(Right.MANAGER) || c2.getRights().isOrInherits(Right.ADMINISTRATOR)
