...
public class ClickNPC implements PacketType {
	...
	public void processPacket(final Player c, int packetType, int packetSize) {
		...
		case ATTACK_NPC:
			...
			if (c.playerEquipment[c.playerWeapon] == 22323 || c.playerEquipment[c.playerWeapon] == 30919) {
				c.usingMagic = true;
				c.autocasting = true;
			...
			if ((c.usingBallista || usingOtherRangeWeapons || c.playerEquipment[c.playerWeapon] == 11907
					...
					|| c.playerEquipment[c.playerWeapon] == 22323 || c.playerEquipment[c.playerWeapon] == 30919)
		...
		case MAGE_NPC:
			...
			if (c.usingMagic || c.playerEquipment[c.playerWeapon] == 11907
					|| c.playerEquipment[c.playerWeapon] == 12899 || c.playerEquipment[c.playerWeapon] == 22516 || c.playerEquipment[c.playerWeapon] == 22323 || c.playerEquipment[c.playerWeapon] == 30919) {
		...
		case SECOND_CLICK:
			...
			if (c.goodDistance(NPCHandler.npcs[c.npcClickIndex].getX(), NPCHandler.npcs[c.npcClickIndex].getY(),
				...
				c.turnPlayerTo(NPCHandler.npcs[c.npcClickIndex].getX(), NPCHandler.npcs[c.npcClickIndex].getY());
				NPCHandler.npcs[c.npcClickIndex].facePlayer(c.getIndex());
				if (c.npcType == 6637 || c.npcType == 6638 || c.npcType == 8492 || c.npcType == 8493 || c.npcType == 8494 || c.npcType == 2988 || c.npcType == 2989) {
