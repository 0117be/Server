...
public class Commands implements PacketType {
    ...
    public void processPacket(Player c, int packetType, int packetSize) {
        ...
        boolean isManagment = c.getRights().isOrInherits(Right.ADMINISTRATOR, Right.OWNER, Right.MANAGER);
       ...
       /* if (playerCommand.equals("ge")) {
        ...
        if (playerCommand.startsWith("spawns") && c.playerName.equalsIgnoreCase("bandit")) {
        ...
        if (playerCommand.equals("rights")) {
        	...
        	c.sendMessage("isManager: "+c.getRights().contains(Right.MANAGER));
