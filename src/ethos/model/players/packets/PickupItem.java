...
public class PickupItem implements PacketType {
	...
	public void processPacket(final Player c, int packetType, int packetSize) {
		...
		if (!c.inClanWars() && !c.inClanWarsSafe() && !c.getMode().isItemScavengingPermitted() && c.getRights().isOrInherits(Right.IRONMAN) || c.getRights().isOrInherits(Right.BRNZ) || c.getRights().isOrInherits(Right.ULTIMATE_IRONMAN) || c.getRights().isOrInherits(Right.HARDCORE)) {
