...
public class CombatAssistant {
	...
	public boolean usingFaerBow() {
		return c.playerEquipment[c.playerWeapon] == 25867;
	}
	...
	public boolean usingBolts(int i) {
		return (i >= 9139 && i <= 9145) || (i >= 9236 && i <= 9245) || (i >= 9286 && i <= 9306) || (i >= 9335 && i <= 9342)|| i == 879 || i == 880 || i == 11875 || i == 21316;
	}
