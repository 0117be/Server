...
public class MeleeData {
	...
	public static void getPlayerAnimIndex(Player c, String weaponName) {
		...
		if (weaponName.contains("hunting knife")) {
		 ...
		 if (c.playerEquipment[c.playerWeapon] == 22545 || c.playerEquipment[c.playerWeapon] == 22542) {//chainmace
		...
		if (weaponName.contains("basket of eggs")) {
			c.playerStandIndex = 1836;
			c.playerWalkIndex = 1836;
			c.playerRunIndex = 1836;
			return;
		}
		if (weaponName.contains("easter")) {
			c.playerStandIndex = 3863;
			c.playerWalkIndex = 3863;
			c.playerRunIndex = 3863;
			return;
		}
		...
		case 12426: //3040, 3039, 3039
			...
			c.playerRunIndex = 1501;
			break;	
			
			
			case 24423: //3040, 3039, 3039
			c.playerStandIndex = 2939;
			c.playerTurnIndex = 2939;
			c.playerWalkIndex = 2939;
			c.playerTurn180Index = 2939;
			c.playerTurn90CWIndex = 2939;
			c.playerTurn90CCWIndex = 2939;
			c.playerRunIndex = 2939;
			break; 
			
	/*	case 24424: //3040, 3039, 3039
	...
	public static int getAttackDelay(Player c, String s) {
		...
		if (c.getItems().getItemCount(30013, true) >= 1 && c.playerEquipment[c.playerWeapon] != 20997 ) {	
			if (c.npcIndex > 0)
				return +3;	
			if (c.playerEquipment[c.playerWeapon] == 20997 && c.getItems().getItemCount(30013, true) >= 1) {
				return 4;
			}
		}
		...
		if (s.endsWith("greataxe"))
			...
			return 6;
		else if (s.equals("leaf-bladed battleaxe"))
			return 6;
