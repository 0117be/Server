		...
		case "start":
			...
			CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
				...
				public void execute(CycleEventContainer container) {
					...
					player.sendMessage("@cr10@You can obtain gear and weapons just east by right clicking the npc.");
					...
					player.sendMessage("@cr10@You also gain bloodmoney through kills!");
					player.sendMessage("@cr10@Enjoy!");
					player.teleportingToDistrict = false;
				//	player.setSidebarInterface(13, 57500); //gearsets
					container.stop();
				}
		...
		case "end":
			...
			CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
				...
				public void execute(CycleEventContainer container) {
					...
					player.getPlayerAssistant().movePlayer(3113, 3497, 0);
