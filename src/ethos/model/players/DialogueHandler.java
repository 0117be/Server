...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 9051:
			sendNpcChat3("Break your bracelet down for 250 ether?", "the bracelet will be destroyed,", "Are you sure you want to do this?", 0,
					"Item Breakdown");
			c.nextChat = 9052;
			break;
		case 9052:
			sendOption2("Break down the Bracelet", "Keep the Bracelet");
			c.dialogueAction = 9052;
			break;
 ...
 */
		case 5151:
			sendOption2("Unlock the Rigour Prayer", "No, save the scroll");
			c.dialogueAction = 5151;
			c.nextChat = -1;
			break;
		case 5152:
			sendOption2("Unlock the Augury Prayer", "No, save the scroll");
			c.dialogueAction = 5152;
			c.nextChat = -1;
			break;
			case 94399:
		...
		case 802:
			...
			break;
		case 803:
			sendNpcChat("While entering the pk-district, you can change your stats",
					"Don't freak out, it will be back to normal when you leave.");
			c.nextChat = 804;
			break;
		case 804:
		...
		case 819:
			...
			break;
		case 820:
			sendOption5("Melee Set", "Ranged Tank Set", "Magic Set", "Tribrid Set", "Next");
		...
		case 16740:
			sendStatement("@red@@cr21@This is a dangerous pking zone@cr21@",
					"@red@are you sure you want to enter?");
			c.nextChat = 16741;
			break;
		case 16741:
			sendOption2("Yes, Risk it.", "Step Back.");
			c.dialogueAction = 16740;
		...
		case 6981:
			sendNpcChat2("Hello adventurer, I can sell you items", "for Raid Points!", 8324, "Raids Manager");			
			c.nextChat = 6982;
			break;
		case 6982:
			sendNpcChat2("You gain points each time you", "complete a Raid!", 8324, "Raids Manager");			
			c.nextChat = -1;
			break;
		...
		case 74:
			sendNpcChat("You're lucky. Better train him good or else TzTok-Jad will find.", "you, JalYt.");
			c.nextChat = -1;
			break;
		...
		case 6966:
			sendOption5("Scorpia", "Callisto", "Venenatis", "Vet'ion", "~Next~");
			c.dialogueAction = 6966;
			break;
			
			
		case 10070:
			sendPlayerChat1("I have an infernal cape here.");
			c.nextChat = 10072;
			break;
		...
		case 10074:
			sendNpcChat("You're lucky. Better train him good or else TzTok-Zek will find.", "you, JalYt.");
			c.nextChat = -1;
			break;
		...
		case 63:
			sendOption5("Resource Area (@red@Wilderness)", "KBD Lair",
					"Godwars Dungeon + 10 KC", "Donator Only Rev Cave", "");
			c.dialogueAction = 61;
			break;
		
		case 1056:
			sendOption5("Armadyl", "Bandos",
					"Saradomin", "Zamorak", "");
			c.dialogueAction = 1056;
			break;
		...
		case 1600:// Vote Booth
			sendOption3("Open Vote Shop", "Vote", "Exchange Tickets");
		...
		case 149:
			...
			break;
		case 6971:
			sendOption2("PvM Gains", "Skilling Gains");
			c.dialogueAction = 6971;
			c.nextChat = -1;
			break;
		case 3301:
		...
		case 5998:
			sendNpcChat3("Only <img=4>@red@Donators @bla@can access the Donator Zone.",
					"Interested in becoming a <img=4>@red@Donator@bla@?",
		...
		case 55872:
			...
			break;
		case 55873:
			sendNpcChat2("Hello, my name is Banky.", "I was hired by Kid Buu to be a travelling banker!", c.talkingNpc,
					"Banky The Banker");
			c.nextChat = 0;
			break;
		case 55875:
		...
		case 1390:
			sendNpcChat1("Hello "+ c.playerName + " What would you like to do?", c.talkingNpc, "Combat Instructor");
			c.nextChat = 1391;
			break;
		...
		case 14400:
			...
			break;
		case 14401:
			sendOption5("Gnome Stronghold Course", "Barbarian Course", "Rooftop Courses", "Werewolf Course", "Wilderness Course @red@(50 Wild)");
			c.dialogueAction = 14400;
			c.nextChat = 0;
			break;
		case 14402:
			sendOption5("Draynor Rooftop Course", "Al Kharid Course", "Varrock Rooftop Course", "Canifis Rooftop Course", "~next~");
			c.dialogueAction = 14402;
			c.nextChat = 0;
			break;
		case 14403:
			sendOption5("Falador Rooftop Course", "Seer's Village Rooftop Course", "Relleka Rooftop Course", "Ardougne Rooftop Course", "~back~");
			c.dialogueAction = 14403;
			c.nextChat = 0;
			break;
		case 14000:
		...
		case 14420:
			sendOption5("Lands End", "Fossil Island", "Crafting Guild", "Feldip Hills", "Puro Puro");
			c.dialogueAction = 14420;
			c.nextChat = 0;		
			break;
						
			case 14421:
				sendOption5("Falador Farm", "Catherby Farm", "Harmony Farm", "Farming Guild", "");
				c.dialogueAction = 14421;
				c.nextChat = 0;		
				break;
			case 14422:
				sendOption5("Lumbridge Swamp", "Karamja Island", "Fishing Guild", "Port Piscarilius", "");
				c.dialogueAction = 14422;
				c.nextChat = 0;		
				break;
			case 14423:
				sendOption5("Feldip Hills", "Puro Puro", "", "", "");
				c.dialogueAction = 14423;
				c.nextChat = 0;		
				break;
			case 14424:
				sendOption5("Lumbridge Mine", "Shilo Village", "Mining Guild", "Fossil Island Mine", "Rune Essence Mine");
				c.dialogueAction = 14424;
				c.nextChat = 0;		
				break;
			case 14425:
				sendOption5("", "Ardougne Stalls", "Pyramid Plunder", "Rogues' Den", "");
				c.dialogueAction = 14425;
				c.nextChat = 0;		
				break;
			case 14426:
				sendOption5("Seer's Village", "Draynor Village", "Woodcutting Guild", "", "");
				c.dialogueAction = 14426;
				c.nextChat = 0;		
				break;
			case 16999:
				c.getDH().sendNpcChat2("Donating can upgrade your account which", "grants you access to plenty of benefits.",
						c.talkingNpc, "Donator King");
				c.nextChat = 17000;
				break;
			case 17000:
				c.getDH().sendNpcChat2("Each donator rank increases your drop rate", "grants you more slayer and pk points.",
						c.talkingNpc, "Donator King");
				c.nextChat = 17001;
				break;
			case 17001:
				c.getDH().sendNpcChat2("We also have beautiful custom donator", "zones you can access with higher ranks.",
						c.talkingNpc, "Donator King");
				c.nextChat = 17002;
				break;
			case 17002:
				c.getDH().sendNpcChat2("Also check the ::discord for", "other benefits and features!",
						c.talkingNpc, "Donator King");
				c.nextChat = -1;
				break;
		case 12001:
		...
		case 2400:
			sendOption5("Imbue Berserker Ring - @red@20M", "Imbue Archer Ring - @red@20M",
					"Imbue Seers Ring - @red@20M", "Imbue Warrior Ring - @red@20M", "More");
		...
		case 2402:
			sendOption5("Imbue Treasonous Ring @red@20M", "Imbue Tyrannical Ring @red@20M", "", "Previous",
					"Close");
		...
		case 2245:
			...
			break;
		case 6993:
			c.getDH().sendNpcChat2("For 25 Pk Points I will grant you",
					"temporary access to my shop.", c.talkingNpc, "Advanced Supply Shop");
			c.nextChat = 6994;
			break;
		case 6994:
			sendOption3("Pay 25 PKP", "No Thanks", "");
			c.dialogueAction = 6993;
			break;
			
			
	/*
	Blood Money Exchange System
	Exchanging Different Amounts
	Giving Points or Tickets
	*/
			
		case 6900:
			sendOption4("Insert 1000 Blood Money", "Insert 5000 Blood Money", "Insert 10K Blood Money","Insert 50K Blood Money");
			c.dialogueAction = 6900;
			break;
			
		case 6901:
			sendStatement("Select from the following options...");
			c.nextChat = 6902;
			break;
			
		case 6902:
			sendOption5("50 PC Points","50 Slayer Points", "15 Boss Points",  "15 PK Points", "1000 Bounty Hunter Points");
			c.dialogueAction = 6902;
			break;
			
		case 6903:
			sendOption5("250 PC Points","250 Slayer Points", "75 Boss Points",  "75 PK Points", "5000 Bounty Hunter Points");
			c.dialogueAction = 6903;
			break;
			
		case 6904:
			sendOption5("500 PC Points","550 Slayer Points", "165 Boss Points",  "165 PK Points", "15000 Bounty Hunter Points");
			c.dialogueAction = 6904;
			break;
			
		case 6905:
			sendOption5("2500 PC Points","3000 Slayer Points", "850 Boss Points",  "850 PK Points", "100,000 Bounty Hunter Points");
			c.dialogueAction = 6905;
			break;
			
			
			case 6990:
				sendStatement("You don't have enough @red@blood money.");
				c.nextChat = -1;
				break;
		...
		case 7461:
			...
			("Would you like to make an entry in the lottery for 25m coins?.", c.talkingNpc, "Gambler");
			c.nextChat = 7462;
		case 7462:
			c.getDH().sendOption2
			("Yes", "No");
			c.dialogueAction = 8936;
		...
		case 0:
			...
			break;
		case 9000:
			sendNpcChat4("Hello!", "My name is Konar and I am a master of the slayer skill.",
					"I can assign you a slayer task within the donator zone.", "Would you like a slayer task?",
					c.talkingNpc, "Konar");
			c.nextChat = 9004;
			break;
		...
		case 9003:
			sendNpcChat4("Hello!", "My name is Konar and I am a master of the slayer skill.",
					"I can assign you a task within the donator zone.", "Would you like a slayer task?",
					c.talkingNpc, "Konar");
			c.nextChat = 9004;
			break;
		case 9004:
		...
		case 9005:
			sendNpcChat4("Hello!", "My name is Konar and I am a master of the slayer skill.",
					...
					"Would you like me to give you an easier task?", c.talkingNpc, "Konar");
			c.nextChat = 9006;
			break;
		case 9006:
		...
		case 579:
			...
			break;
//Revenant Emblem Trader
		case 5411:
			sendNpcChat3("Don't suppose you've come across any emblems", "from around the Revenant Caves?",
					"have you? I'll pay dearly..",
					c.talkingNpc, "Emblem Trader");
			c.nextChat = -1;
			break;
		// Eric Hunter
		...
		case 580:
			sendStatement("Ho Ho Ho, Merry christmas!");
			c.nextChat = 581;
			break;
		...
		case 582:
			sendStatement("Strange, another player asked the same thing.",
		...
		case 584:
			sendStatement("Ho Ho Ho, aren't you a little rascal.", "I hope you like smithing because you will",
					"be getting tons of coal this year.");
			c.nextChat = -1;
			break;

		case 585:
			sendStatement("Ho Ho Ho, I see your name on the nice list.", "Would you like to help me?");
			c.nextChat = 586;
			break;
		...
		case 587:
			sendStatement("Alright then, come back if you do.", "Happy holidays.");
			c.nextChat = -1;
			break;

		case 588:
			sendStatement("Thank you, let me explain my dilemma...");
			c.nextChat = 589;
			break;

		case 589:
			sendStatement("Each and every year presents are made by the elves",
		...
		case 590:
			sendStatement("Normally we travel in our sleigh.", "However due to us @blu@crashing",
					"caused by the mass amount of players in edgeville", "we can no longer travel with it.");
			c.nextChat = 591;
			break;

		case 591:
			sendStatement("The only choice we have is to go by foot and go",
					"from station-to-station which is very tedious for our little elves.");
			c.nextChat = 592;
			break;

		case 592:
			sendStatement("I need you to go from station-to-station to further",
		...
		case 593:
			sendStatement("The second is the finalization stage.", "This happens at @blu@Station #2@bla@.");
			c.nextChat = 594;
			break;

		case 594:
			sendStatement("You must bring each toy to station 1, and station 2.",
		...
		case 595:
			sendStatement("Each station will have a unique engineer.",
		...
		case 596:
			...
			sendStatement("Do you understand everything or should I repeat", "myself? It's no trouble.");
			c.nextChat = 597;
			break;
		...
		case 598:
			...
			if (stage == 2) {
				sendStatement("The first toy is a @blu@" + ItemAssistant.getItemName(ChristmasToy.STAR.getItems()[0])
						+ "@bla@.");
			} else if (stage > 2) {
				sendStatement("The next toy is a @blu@"
		...
		case 599:
			...
			if (c.getItems().freeSlots() == 0) {
				sendStatement("I need to give you the toy to continue.",
						"You must get one free slot, come back when you do.");
				c.nextChat = -1;
				return;
			}
			c.getItems().addItem(toy.getItems()[0], 1);
			sendStatement("You must take this item to each station.", "If you need directions, talk to me again.",
		...
		case 601:
			sendStatement("Let me reiterate for you.");
			c.nextChat = 589;
			break;

		case 602:
			sendStatement("The first station is at the top of the ice-path.", "Right-click on me to go there",
					"Note: It is very cold and slippery, you might take damage.");
			c.nextChat = 603;
			break;

		case 603:
			sendStatement("The second station is next the mountain.", "directly south-west of the ice-path.");
			c.nextChat = 600;
			break;
		...
		case 604:
			...
			if (stage == HolidayController.CHRISTMAS.getMaximumStage()) {
				sendStatement("Thank you for helping us, and santa.", "Woah, did you hear that?",
			...
			if (!c.getItems().playerHasItem(toyId)) {
				sendStatement("Hello there, you should get a toy", "from santa and come back.",
			...
			if (CycleEventHandler.getSingleton().isAlive(c, CycleEventHandler.Event.CHRISTMAS_ENGINEER)) {
				sendStatement("This should only take a few more seconds.", "Please wait.");
				c.nextChat = -1;
				return;
			}
			sendStatement("I will upgrade this for you, this should only take", "5 seconds or so.");
			c.nextChat = -1;
		...
		case 606:
			sendStatement("The toy has been further developed and is now", "ready to be completed. Go to the second",
		...
		case 607:
			sendStatement("The toy has finished being developed.", "Talk to santa in edgeville.");
			c.dialogueAction = -1;
			c.nextChat = -1;
			break;
		...
		case 609:
			...
			if (!c.getItems().playerHasItem(toyId)) {
				sendStatement("You don't have the toy upgraded yet.", "Talk to me when you do.");
				c.nextChat = -1;
				return;
			}
			...
			if (!nextToy.isPresent()) {
				...
				sendStatement("Thank you for helping me.", "I have given you a @whi@Snow Santa Hat@bla@",
		...
		case 610:
			sendStatement("I cannot thank you enough for the help " + Misc.capitalize(c.playerName) + ".",
					"Would you like to enter the xmas dungeon? You must",
					"wear the snow santa hat to successfully attack monsters.");
			c.nextChat = 611;
			break;

		case 611:
			sendOption2("Sounds fun!", "No, thanks");
		...
		case 645:
			sendNpcChat("Time to select a game mode!", "You have the option to play as an <img=12></img> Iron Man,",
					"<img=13></img> Ultimate Ironman, <img=23></img> Hardcore Iron Man,", "or a Regular player.");
			c.nextChat = 646;
			break;
		...
		case 647:
			if (c.getMode().getType().equals(ModeType.OSRS)) {
				sendNpcChat("You have chosen to play with Extreme XP rates, good luck!");
			...
			} else if(c.getMode().getType().equals(ModeType.BRNZ)){
				sendNpcChat("You have chosen to play as a bronze man.",
						"Take this set of armour to help you on your way.");
				...
				sendNpcChat("You have chosen to play as an Hardcore Ironman.",
						"Take this set of armour to help you on your way.");
			}
			c.getTutorial().proceed();
			break;
	...
	case 648:
		...
		case 649:
			...
			c.getTutorial().proceed();
				...
				sendOptions("Extreme (1x & 10% DR Boost)", "Regular (50x & No Boost)");
				c.dialogueAction = 648;	
				c.nextChat = 648;
				c.getTutorial().proceed();
		...
		case 650:
			if (c.getRights().isOrInherits(Right.IRONMAN) || c.getRights().isOrInherits(Right.ULTIMATE_IRONMAN) || c.getRights().isOrInherits(Right.HARDCORE)) {
		...
		case 6600:
			sendNpcChat("Hardcore Iron Man accounts have all the restrictions of",
					"regular Iron man accounts with an added 10% drop rate",
					"boost. When these accounts die, they lose their rank",
					"as well as the boost & revert to an Ironman");
			c.nextChat = -1;
			break;
		case 6601:
			sendNpcChat("Bronze Man accounts have all the restrictions of",
					"regular Iron man accounts, as well as no access to shops.",
					"Although you can trade with other members in your CC.",
					"This mode recommends you have a team");
			c.nextChat = -1;
			break;
		case 661:
			if (!c.getRights().isOrInherits(Right.IRONMAN) && !c.getRights().isOrInherits(Right.ULTIMATE_IRONMAN) && !c.getRights().isOrInherits(Right.HARDCORE)) {
			...
			EquipmentSet set = c.getRights().isOrInherits(Right.IRONMAN) ? EquipmentSet.IRON_MAN_ARMOUR
					: c.getRights().isOrInherits(Right.ULTIMATE_IRONMAN) ? EquipmentSet.ULTIMATE_IRON_MAN_ARMOUR
							: c.getRights().isOrInherits(Right.HARDCORE) ? EquipmentSet.HARDCORE_ARMOUR: null;
		...
		case 672:
			sendOption2("Yes, show me the tutorial.", "No thanks, I know what I'm doing.");
			c.dialogueAction = 672;			
			break;

		case 673:
			sendNpcChat("Hello! You must be looking for a new server.", "Well lucky for you, Revelation", "Is a content packed server, with a ton", "of unique features only seen here.");
			c.nextChat = 674;
			break;

		case 674:			
			sendNpcChat("I'm sure you don't want me to take", "you on a tutorial, so we will skip that for now.");
			c.nextChat = 676;
			break;

		case 677:
			c.getPA().movePlayer(3247, 10170, 16);
			
					sendNpcChat("This is the Revenant Caves, you can", "come here to make great money or obtain powerful weapons",
							"Be careful though; This is a dangerous area!");
					c.nextChat = 6777;
			break;
		case 6777:
					sendNpcChat("I have removed all the monster spawns for your safety", "this is also a PvP area",
							"meaning players can attack you!");
					c.nextChat = 678;
			break;
		case 676:					
			sendNpcChat("If you would like a tutorial", "or have any questions you can talk to me",
					"after we setup your account!");
			c.nextChat = 645;
			break;

			case 678:
				c.getPA().movePlayer(2662, 3306, 0);			
				sendNpcChat("You can start thieving stalls", "here in Ardougne.", 
						"Thieving is a great method to gain beginner cash.");
				c.nextChat = 679;
				break;
		...
		case 679:
			c.getPA().movePlayer(3079, 3499, 0);
			sendNpcChat("Here you will find all of the altars,", "along with the crystal key chest.");
			c.nextChat = 680;
		case 680:
			c.getPA().movePlayer(3675, 3219, 0);
			sendNpcChat("You can obtain the best items in-game", "by doing raids, either solo or with friends!",
					"Every Weekend we have double raid loot!");
			c.nextChat = 681;
			break;
		case 681:
		...
		case 6161:
			sendNpcChat3("Since you're a bronzie like me", "I will exchange your points for", "a few different rewards.", 0,
					"Bronzie Brian");
			c.nextChat = 6162;
			break;
		case 6162:
			sendOption3("100 Boss Points ~ Care Package", "100 PK Points ~ Care Package", "1M Bounty Hunter Points ~ Care Package");
			c.dialogueAction = 6162;
			break;
			/**
			 * Bonus Xp & Double Drop books
			 */
					case 9029:
						sendNpcChat3("Opening this book will grant you", "35% bonus Experience for 30 min", "Are you sure you want to claim?", 0,
								"Bonus Book");
						c.nextChat = 9030;
						break;
					case 9030:
						sendOption2("Open the book", "Save it for later");
						c.dialogueAction = 9030;
						break;
					case 9033:
						sendNpcChat3("Opening this book will grant you", "35% bonus Experience for 15 min", "Are you sure you want to claim?", 0,
								"Bonus Book");
						c.nextChat = 9034;
						break;
					case 9034:
						sendOption2("Open the book", "Save it for later");
						c.dialogueAction = 9034;
						break;
					case 9035:
						sendNpcChat3("Opening this book will grant you", "35% bonus Experience for 60 min", "Are you sure you want to claim?", 0,
								"Bonus Book");
						c.nextChat = 9036;
						break;
					case 9036:
						sendOption2("Open the book", "Save it for later");
						c.dialogueAction = 9036;
						break;
					case 9037:
						sendNpcChat3("Opening this book will grant you", "35% bonus Experience for 90 min", "Are you sure you want to claim?", 0,
								"Bonus Book");
						c.nextChat = 9038;
						break;
					case 9038:
						sendOption2("Open the book", "Save it for later");
						c.dialogueAction = 9038;
						break;
					case 9039:
						sendNpcChat3("Opening this book will grant you", "35% bonus Experience for 3 hours", "Are you sure you want to claim?", 0,
								"Bonus Book");
						c.nextChat = 9040;
						break;
					case 9040:
						 ...
						 */
					case 9031:
						sendNpcChat3("Opening this book will grant you", "Double drops for 15 minutes", "Are you sure you want to claim?", 0,
								"Bonus Book");
						c.nextChat = 9032;
						break;
					case 9032:
						sendOption2("Open the book", "Save it for later");
						c.dialogueAction = 9032;
						break;
					case 9043:
						sendNpcChat3("Opening this book will grant you", "Double drops for 30 minutes", "Are you sure you want to claim?", 0,
								"Bonus Book");
						c.nextChat = 9044;
						break;
					case 9044:
						...
						break;
					case 9045:
						sendNpcChat3("Opening this book will grant you", "Double drops for 60 minutes", "Are you sure you want to claim?", 0,
								"Bonus Book");
						c.nextChat = 9046;
						break;
					case 9046:
						...
						break;
					case 9047:
						sendNpcChat3("Opening this book will grant you", "Double drops for 90 minutes", "Are you sure you want to claim?", 0,
								"Bonus Book");
						c.nextChat = 9048;
						break;
					case 9048:
						...
						break;
					case 9049:
						sendNpcChat3("Opening this book will grant you", "Double drops for 3 hours", "Are you sure you want to claim?", 0,
								"Bonus Book");
						c.nextChat = 9050;
						break;
					case 9050:
						sendOption2("Open the book", "Save it for later");
						c.dialogueAction = 9050;
						break;
		case 11824:
		...
		case 712:
			sendNpcChat("All of the teleports are in the bottom right tab");
			c.nextChat = 710;
			break;

		case 713:
			sendNpcChat("Yes, you must follow all of the rules", "Make sure you are aware of them! You can",
		...
		case 715:
			sendNpcChat("If you have been lucky enough to get your hands on",
					...
					"them into points by using the Vote Booth", "inside the bank!");
			c.nextChat = 710;
			break;
		case 1577:
		...
		case 900:
			sendNpcChat4("Hello! Would you like to enable Daily Tasks?", "These tasks can be assigned and completed",
					"once a day for some pretty neat rewards!", "Enable Daily Tasks?", 4680, "Daily Task Master");
			c.nextChat = 901;
			break;
		case 901:
		...
		case 902:
			sendNpcChat2("Please select your preference on the type", "of tasks you would like to receive!", 7371,
					"Daily Task Master");
			c.nextChat = 903;
			break;
		case 903:
		...
		case 904:
			sendNpcChat2("You have enabled daily tasks! Please", "press continue to select a task preference.", 7371,
					"Daily Task Master");
			c.nextChat = 902;
			break;
		case 905:
			sendNpcChat2("You have disabled daily tasks! Talk to", "me if you change your mind.", 7371,
					"Daily Task Master");
			c.nextChat = 0;
			break;

		case 906:
			sendNpcChat2("Great, your tasks will now be PvM related", "until you change your mind!", 7371,
					"Daily Task Master");
			c.nextChat = 0;
			...
			break;
		case 907:
			sendNpcChat2("Great, your tasks will now be Skilling related", "until you change your mind!", 7371,
					"Daily Task Master");
			c.nextChat = 0;
			DailyTasks.complete(c);
			DailyTasks.assignTask(c);
