...
public enum Mineral {			
	...
	COPPER(new int[] { 7484, 11961, 11960, 11962, 13709, 7453 }, "bronze", 1, 18, 10, 5, 15, 15000, true, generateExclusive(436)), 
	TIN(new int[] { 7485, 9714, 9716, 11957, 11958, 11959, 13712 }, "bronze", 1, 18, 10, 5, 15, 15000, true, generateExclusive(438)), 
	IRON(new int[] { 7488, 11954, 11955, 11956, 13710, 13444, 13445, 13446, 7455 }, "iron", 15, 35, 10, 8, 17, 14800, true, generateExclusive(440)), 
	SILVER(new int[] { 7490 }, "silver", 20, 40, 10, 8, 17, 14800, true, generateExclusive(442)), 
	COAL(new int[] { 7489, 9717, 9718, 9719, 2096, 13714, 13706, 7456 }, "none", 30, 50, 6, 15, 29, 14600, true, generateExclusive(453)), 
	GOLD(new int[] { 7491, 7458, 9722, 9720, 13707, 14962, 14963, 14964, 13441, 13442, 13443, 8728, 8975 }, "gold", 40, 65, 6, 25, 32, 14200, true, generateExclusive(444)), 
	MITHRIL(new int[] { 7492, 13718, 7459 }, "mithril", 55, 80, 6, 40, 33, 13800, true, generateExclusive(447)), 
	ADAMANT(new int[] { 7493, 13720, 7460 }, "adamant", 70, 95, 4, 50, 34, 13200, true, generateExclusive(449)), 
	RUNE(new int[] { 7494, 7461, 14175 }, "rune", 85, 125, 2, 100, 35, 12500, true, generateExclusive(451)), 
	ESSENCE(new int[] { 7471, 14912 }, "none", 30, 5, -1, -1, 20, 15000, false, generateExclusive(7936)),
	AMETHYST(new int[] { 30371, 30372 }, "none", 92, 140, 2, 100, 35, 11500, false, generateExclusive(21347)),			
	GEM(new int[] { 9030, 7464, 7463}, "none", 40, 60, 20, 25, 20, 15000, true, new MineralReturn() {
				@Override
				public int generate() {
				...
				public int[] inclusives() {
					return new int[] { 1625, 1627, 1623, 1621, 1619, 1617, 1631 };
				}
