 ...
 */
		...
		ItemDefinition definition = ItemDefinition.forId(item.getId());
		 if (Misc.random(stall.petChance) == 20 && player.getItems().getItemCount(20663, false) == 0 && player.summonId != 20663) {
			 PlayerHandler.executeGlobalMessage("[<col=CC0000>News</col>] @cr20@ <col=255>" + player.playerName + "</col> now goes hand in hand with a <col=CC0000>Rocky</col> pet!");
				DiscordMessager.sendPetsMessage("```[Pet Manager]" + player.playerName + " now goes hand in hand with a Rocky pet!```");
		 ...
		 * 10 * 40 + 10 * 40 / 10 * 4
		 */
		xpBoostOSRS = (experience + experience / 10) * pieces /2;
		xpBoostReg = (experience * Config.THIEVING_EXPERIENCE + experience * Config.THIEVING_EXPERIENCE / 10) * pieces /2;
		osrsExperience = (experience + experience / 10) + xpBoostOSRS;
		regExperience = (experience * Config.THIEVING_EXPERIENCE + experience * Config.THIEVING_EXPERIENCE / 10) + xpBoostReg;
	...
	public void steal(Pickpocket pickpocket, NPC npc) {
		...
		case MAN:
			...
			if (Boundary.isIn(player, Boundary.LUMRIDGE_BOUNDARY)) {
				...
				DailyTasks.increase(player, PossibleTasks.MAN);
			break;
		case GNOME:
		...
		case HERO:
			...
			DailyTasks.increase(player, PossibleTasks.HERO);
			break;
		case MENAPHITE_THUG:
	...
	public enum Pickpocket {
		MAN(1, 8, 55000, new HashMap<Rarity, List<GameItem>>() {
			...
			{
				put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 5000), new GameItem(995, 7000), new GameItem(995, 10000)));
				put(Rarity.UNCOMMON, Arrays.asList(new GameItem(560, 2), new GameItem(565), new GameItem(444), new GameItem(1601)));
			}
			}), FARMER_RAIDS(85, 65, 52000, new HashMap<Rarity, List<GameItem>>() {
				{
					put(Rarity.ALWAYS, Arrays.asList(new GameItem(20853, 5), new GameItem(20906), new GameItem(20909), new GameItem(20903)));
					put(Rarity.RARE, Arrays.asList(new GameItem(20853, 50), new GameItem(20992), new GameItem(5300)));
				}
			}), HERBLORE_SECONDARIES(75, 65, 52000, new HashMap<Rarity, List<GameItem>>() {
				{
					put(Rarity.ALWAYS, Arrays.asList(new GameItem(222), new GameItem(236), new GameItem(1526)));
					put(Rarity.COMMON, Arrays.asList(new GameItem(224), new GameItem(9738), new GameItem(232), new GameItem(226), new GameItem(240),
					 new GameItem(244), new GameItem(6050), new GameItem(6052), new GameItem(3139), new GameItem(6694), new GameItem(2971), new GameItem(248), new GameItem(6017), new GameItem(246)));
				}
			}), MINER(85, 100, 38000, new HashMap<Rarity, List<GameItem>>() {
				{
					put(Rarity.ALWAYS, Arrays.asList(new GameItem(2352, 1), new GameItem(2360, 1), new GameItem(2350, 1)));
					put(Rarity.UNCOMMON, Arrays.asList(new GameItem(2358, 1), new GameItem(2362), new GameItem(441, 10), new GameItem(450, 10), new GameItem(448, 10)));
					put(Rarity.RARE, Arrays.asList(new GameItem(1271, 1), new GameItem(1275), new GameItem(452)));
				}
			}), GUARD(40, 40, 38000, new HashMap<Rarity, List<GameItem>>() {
				{
					put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 5000), new GameItem(995, 7500), new GameItem(995, 6500)));
				}
			}), KING(55, 60, 38000, new HashMap<Rarity, List<GameItem>>() {
				{
					put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 5000), new GameItem(995, 7500), new GameItem(995, 8000)));
				}
			}), PALADIN(70, 90, 38000, new HashMap<Rarity, List<GameItem>>() {
				{
					put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 5000), new GameItem(995, 7500), new GameItem(995, 10000)));
				}
			}), COOK(65, 100, 38000, new HashMap<Rarity, List<GameItem>>() {
				{
					put(Rarity.ALWAYS, Arrays.asList(new GameItem(378, 1), new GameItem(384, 1), new GameItem(390, 1)));
					put(Rarity.UNCOMMON, Arrays.asList(new GameItem(11935, 1), new GameItem(384, 3)));
					put(Rarity.RARE, Arrays.asList(new GameItem(11935, 3), new GameItem(11940, 10), new GameItem(313, 20)));
				}
				}), MAGIC(95, 100, 38000, new HashMap<Rarity, List<GameItem>>() {
					{
						put(Rarity.ALWAYS, Arrays.asList(new GameItem(556, 2), new GameItem(555, 2), new GameItem(554, 2)));
						put(Rarity.UNCOMMON, Arrays.asList(new GameItem(9075, 1), new GameItem(565), new GameItem(560, 1), new GameItem(561, 1), new GameItem(566, 1)));
						put(Rarity.RARE, Arrays.asList(new GameItem(4101, 1), new GameItem(4099), new GameItem(4105),new GameItem(4107), new GameItem(4103)));
				}
				}
		);
	...
	public enum Stall {
		...
		Tea(new GameItem(712), 5, 16, 20, 45000),
		...
		Rogue(new GameItem(1625), 50, 60, 10, 40000),
		Rogue1(new GameItem(1623), 50, 60, 10, 40000),
		Rogue2(new GameItem(1621), 50, 60, 10, 40000),
		Rogue3(new GameItem(1619), 50, 60, 10, 40000),
		Rogue4(new GameItem(1631), 50, 60, 10, 40000),
		Rogue5(new GameItem(6571), 50, 60, 10, 40000),
		Fur(new GameItem(6814), 35, 47, 10, 40000),
		Rune(new GameItem(451), 85, 70, 10, 40000),
		Infernogems(new GameItem(1617), 85, 70, 10, 40000),
