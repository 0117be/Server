...
public final class Hunter {
	...
	public static boolean lay(Player player, Trap trap) {
		...
		if (!Boundary.isIn(player, Boundary.HUNTER_BOUNDARIES) && !Boundary.isIn(player, Boundary.DONATOR_ZONE)  && !Boundary.isIn(player, Boundary.EDONATOR_ZONE)) {
	...
	public static boolean claim(Player player, GlobalObject object) {
		...
		if (randomGold == 2 && player.getItems().getItemCount(13326, false) == 0 && player.summonId != 13326) {
			...
			DiscordMessager.sendPetsMessage("```[Pet Manager]" + player.playerName + " caught a Golden Chinchompa pet lucky enough!```");
		...
		case 10033:
			if (randomGray == 25 && player.getItems().getItemCount(13324, false) == 0 && player.summonId != 13324) {
				...
				DiscordMessager.sendPetsMessage("```[Pet Manager]" + player.playerName + " trapped & caught a Gray Chinchompa pet!```");
		...
		case 10008:
			if (randomRed == 15 && player.getItems().getItemCount(13323, false) == 0 && player.summonId != 13323) {
				...
				DiscordMessager.sendPetsMessage("```[Pet Manager]" + player.playerName + " trapped & caught a Red Chinchompa pet!```");
		...
		case 11959:
			if (randomBlack == 8 && player.getItems().getItemCount(13325, false) == 0 && player.summonId != 13325) {
				...
				DiscordMessager.sendPetsMessage("```[Pet Manager]" + player.playerName + " trapped & caught a Black Chinchompa pet!```");
