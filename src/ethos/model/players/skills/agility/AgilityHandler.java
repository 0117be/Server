...
public class AgilityHandler {
	...
	public double getXp(int objectId) {
		...
		case WerewolfAgility.STEPPING_STONE:
			return 20;
	...
	private int getLevelRequired(int objectId) {
		...
		case RooftopAlkharid.ROUGH_WALL1:
			return 20;
			
		case RooftopCanifis.TALL_TREE:
			return 40;
		case RooftopFalador1.ROUGH_WALL:
			return 50;
		case RooftopRelleka.ROUGH_WALL:
			return 80;
		...
		//case RooftopDraynor.ROUGH_WALL:
		//	return 10;
	...
	public int getAnimation(int objectId) {
		...
		case WerewolfAgility.STEPPING_STONE:
			...
			case WerewolfAgility.HURDLE:
				return STONE;
			case WerewolfAgility.TUNNEL1:
				return PIPES_EMOTE;
			case WerewolfAgility.SKULLS:
				return CLIMB_UP_EMOTE;
			case WerewolfAgility.ZIPLINE:
				return ZIPLINE;
	...
	public static boolean failObstacle(final Player c, int x, int y, int z) {
		...
		int chance = 50 + c.playerLevel[c.playerAgility] / 13;
			...
			Achievements.increase(c, AchievementType.AGIL, 1);
			 if (Misc.random(petChance) == 20 && c.getItems().getItemCount(20659, false) == 0 && c.summonId != 20659) {
				 PlayerHandler.executeGlobalMessage("[<col=CC0000>News</col>] @cr20@ <col=255>" + c.playerName + "</col> is apperantly agile like a <col=CC0000>Squirrel</col> pet!");
					DiscordMessager.sendPetsMessage("```[Pet Manager]" + c.playerName + " is apperantly agile like a Squirrel pet!```");
