...
public enum Title implements Comparator<Title> {
	...
	GRAVE_DIGGER("Grave Digger", 0, TitleCurrency.NONE, new TitleRequirement() {
		...
		@Override
		public boolean meetsStandard(Player player) {
			return player.getAchievements().isComplete(AchievementTier.TIER_3.ordinal(), Achievement.Slayer_chest_III.getId());
		}
	}, "To receive access to this title, a player must complete the barrows minigame at least 750 times."),
	...
	HARDCORE("Hardcore", 0, TitleCurrency.NONE, new TitleRequirement() {

		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.HARDCORE);
		}
