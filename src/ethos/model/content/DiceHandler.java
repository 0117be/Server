...
public class DiceHandler {
	...
	public static final Boundary DICING_AREA = new Boundary(3107, 3485, 3113, 3498);
	...
	public static void rollDice(Player c) {
		...
		if (System.currentTimeMillis() - c.diceDelay >= 5000) {
			...
			PlayerHandler.nonNullStream()
					...
					.forEach(player -> {
						player.sendMessage("[@red@DICE@bla@] @cr18@ @blu@" + Misc.capitalizeJustFirst(c.playerName)
