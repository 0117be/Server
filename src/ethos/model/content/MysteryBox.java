...
public class MysteryBox extends CycleEvent {
    ...
    static {
        ...
        items.put(Rarity.RARE,
                Arrays.asList(
                        ...
                        new GameItem(6922, 1),
                        new GameItem(6924, 1),
                        new GameItem(12528, 1),
                        new GameItem(12530, 1),
                        new GameItem(12526, 1),
                        new GameItem(12532, 1),
                        new GameItem(12534, 1),
                        new GameItem(12536, 1),
                        new GameItem(12538, 1),
                        new GameItem(20002, 1),
                        new GameItem(20062, 1),
                        new GameItem(20065, 1),
                        new GameItem(20143, 1),
                        new GameItem(22246, 1),
                        new GameItem(6949, 1),
                        new GameItem(20017, 1),
    ...
    public void open() {
    	...
    	Achievements.increase(player, AchievementType.MBOX, 1);
