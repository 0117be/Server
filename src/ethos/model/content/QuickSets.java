...
public class QuickSets {
	...
	public enum QUICKSETS {
		...
		F2P_PURE(6, 
				...
				new int[][] { { 5698, 1 }, { 4151, 1 }, { 2440, 1 }, { 3040, 1 }, { 3024, 2 }, { 6685, 3 }, { 11936, 16 }, { 555, 1000 }, { 560, 1000 }, { 565, 1000 } }),
		TRIBRID(7, 
				new int[][] { { 10828, 1 }, { 2412, 1 }, { 1704, 1 }, { 4675, 1 }, { 4091, 1 }, { 3842, 1 }, { -1, -1 }, { 4093, 1 }, { -1, -1 }, { 7462, 1 }, { 3105, 1 }, { -1, -1 }, { 2550, 1 }, { 9244, 250 } }, 
				new int[][] { { 5698, 1 }, { 4151, 1 }, { 3040, 1 }, { 2440, 1 }, { 3024, 2 }, { 6685, 3 }, { 2503, 1 }, { 1079, 1 }, { 11936, 12 }, { 9185, 1 },  { 10499, 1 }, { 555, 1000 }, { 560, 1000 }, { 565, 1000 } });
		...
		for (QUICKSETS set : QUICKSETS.values()) {
			...
			if (setId == set.id) {
				...
				case 5:
					...
					player.getPA().setSkillLevel(6, player.playerLevel[5], player.playerXP[5]);
