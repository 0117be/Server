 ...
 */
public class JarofSwamp extends CycleEvent {

    /**
     * The item id of the mystery box required to trigger the event
     */
    private static final int MYSTERY_BOX = 12936;
    ...
    static {
        items.put(Rarity.COMMON,
                Arrays.asList(
                		new GameItem(12696, 25),
                		new GameItem(6571, 5),
                		new GameItem(11944, 100),
     ...
     */
    public JarofSwamp(Player player) {
        this.player = player;
    }
