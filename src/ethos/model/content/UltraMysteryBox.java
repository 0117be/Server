...
public class UltraMysteryBox {
	...
	static {
		items.put(Rarity.COMMON, 
			Arrays.asList(			
				...
				new GameItem(11944, 250),//250 lava d bones
				new GameItem(11944, 350),//350 lava d bones
				new GameItem(12831),//Blessed Spirit Shield
				new GameItem(2572),//Ring Of Wealth	
				new GameItem(6570, 3),//Uncut Onyx		
		...
		items.put(Rarity.RARE,
				Arrays.asList(
					...
					//	new GameItem(20997),//twisted bow
						...
						//new GameItem(22322),//Averic Defender
	...
	public void reward() {
		...
		if (random > 49) {
			PlayerHandler.executeGlobalMessage("<col=d000ff><shad=7000>[Ultra]@cr7@ " + Misc.formatPlayerName(player.playerName)
					+ " opened an ultra and got a "+name+"!");
		}
