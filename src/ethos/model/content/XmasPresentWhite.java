 ...
 */
public class XmasPresentWhite extends CycleEvent {

    /**
     * The item id of the mystery box required to trigger the event
     */
    private static final int MYSTERY_BOX = 32102;
    ...
    static {
        items.put(Rarity.COMMON,
                Arrays.asList(
                        ...
                        new GameItem(10501, 3))
        );

        items.put(Rarity.UNCOMMON,
                Arrays.asList(
                	       new GameItem(1464, 10),       new GameItem(1464, 10),       new GameItem(1464, 10),
                        new GameItem(1464, 10),
                        new GameItem(13346, 1),
                        new GameItem(23071, 1),
                        new GameItem(20791, 1),
                        new GameItem(30230, 1),
     ...
     */
    public XmasPresentWhite(Player player) {
        this.player = player;
    }
