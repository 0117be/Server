...
public class Christmas extends Holiday {
	...
	public boolean clickNpc(Player player, int type, int npcId) {
		...
		case 1:
			...
			case 8050:
				...
				case 0:
					player.getDH().sendDialogues(580, 8050);
					return true;

				case 1:
					player.getDH().sendDialogues(588, 8050);
					return true;
				...
				case 5:
				case 6:
					player.getDH().sendDialogues(599, 8050);
					return true;

				case 7:
					player.getDH().sendDialogues(610, 8050);
	...
	public boolean clickButton(Player player, int buttonId) {
		...
		case 9157:
			if (player.dialogueAction == 115) {
				...
				player.getPA().spellTeleport(2772, 10232, 0, false);
				return true;
			}
			break;
	...
	public void receive(Player player) {
		if (!player.getItems().addItem(32103, 1)) {
			player.getItems().sendItemToAnyTabOrDrop(new BankItem(32103, 1), player.getX(), player.getY());
	...
	public void initializeHoliday() {
		NPCHandler.spawnNpc(8050, 3107, 3507, 0, 5, 0, 0, 0, 0);
		NPCHandler.spawnNpc(1046, 1111, 1111, 0, 1, 1000, 40, 250, 400);
	...
	public void finalizeHoliday() {
		for (int npcId : Arrays.asList(8050, 4895, 4893, 1046)) {
