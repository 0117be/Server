...
public class Snowfall {
	...
	private static final int[][] SNOW_LOCATIONS = new int[][] { 
		{ 3103, 3508 }, { 3103, 3513 }, { 3095, 3518 }, { 3087, 3517 }, { 3093, 3501 }};
	...
	public void update() {
		...
		PlayerHandler.executeGlobalMessage("<shad=7000>@red@The Christmas event is @gre@active@red@ until December 30th!");
