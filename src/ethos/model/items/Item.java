...
public class Item {
	...
	public static int legs[] = { 10438, 10434, 20842, 10430, 10426, 10422, 10418, 10414, 10410, 10406, 10402, 7609, 2522, 7378,
			...
			7398, 7386, 6324, 6343, 6353, 7116, 7126, 7132, 7134, 3387, 5036, 5038, 5040, 13873, 22328, 23979, 24668, 23339,
			24421};
	...
	public static int platebody[] = { 12277, 12235, 12205, 11020, 13887, 13884, 13858, 10551, 10338, 7608, 2520, 430,
			...
			5034, 7392, 1035,577, 22327, 23975, 24666, 23336, 24420};
	...
	private static String[] fullmask = { "helm", "helmet_imbued", "helm_(g)", "Bronze_full_helm", "Iron_full_helm",
			...
			"slayer helmet (i)", "rogue mask", "santa mask", "antisanta mask", "Splitbark helm", "Justiciar faceguard", "Clown mask"
	};
	...
	static {
		try {
			...
			for (String data : stackableData) {
				...
				itemStackable[20791] = true;
				itemStackable[6646] = true;
				itemStackable[6651] = true;
				itemStackable[3451] = true;
				itemStackable[21930] = true;
				itemStackable[6802] = true;
				itemStackable[20358] = true;
				itemStackable[20360] = true;
				itemStackable[20362] = true;
				itemStackable[13648] = true;
				itemStackable[21233] = true;
				itemStackable[13649] = true;
				itemStackable[13650] = true;
				itemStackable[3339] = true;
				itemStackable[989] = true;
				itemStackable[405] = true;
				itemStackable[11739] = true;
				itemStackable[6199] = true;
				itemStackable[11738] = true;
				itemStackable[13346] = true;
				itemStackable[21347] = true;
				itemStackable[3464] = true;
				itemStackable[985] = true;
				itemStackable[3460] = true;
				itemStackable[987] = true;
				itemStackable[11337] = true;
				itemStackable[23071] = true;
				itemStackable[1525] = true;
				itemStackable[1526] = true;
			}
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			...
			itemIsNote[22781] = true;
			itemIsNote[22784] = true;
			itemIsNote[22787] = true;
			
			itemIsNote[21348] = true;//Amethyst Rock
			/**
			 * Mystic set (Dusk)
			 */
			itemIsNote[23048] = true;
			itemIsNote[23051] = true;
			itemIsNote[23054] = true;
			itemIsNote[23057] = true;
			itemIsNote[23060] = true;
			/**
			 * Brimstone items, Dragon Hunter lance, Boots of stone, Hydra items, Drake items etc
			 */
			itemIsNote[23038] = true;
			itemIsNote[22952] = true;
			itemIsNote[22955] = true;
			itemIsNote[22958] = true;
			itemIsNote[22961] = true;
			itemIsNote[22976] = true;
			itemIsNote[22979] = true;
			/**
			 * Craw's, Viggora's, & Thammaron's
			 */
			itemIsNote[22543] = true;//Viggora's
			itemIsNote[22548] = true;//Craw's
			itemIsNote[22553] = true;//Thammaron's
			itemIsNote[21818] = true;//bracelet of Etherum
			/**
			 * PvP Sets
			 */
			//Morrigan
			itemIsNote[22639] = true;
			itemIsNote[22642] = true;
			itemIsNote[22645] = true;
			//Vesta
			itemIsNote[22611] = true;
			itemIsNote[22614] = true;
			itemIsNote[22617] = true;
			itemIsNote[22620] = true;
			//Zuriel
			itemIsNote[22648] = true;
			itemIsNote[22651] = true;
			itemIsNote[22654] = true;
			itemIsNote[22657] = true;
			//statius
			itemIsNote[22623] = true;
			itemIsNote[22626] = true;
			itemIsNote[22629] = true;
			itemIsNote[22632] = true;
			/**
			 * End of PvP sets
			 */
