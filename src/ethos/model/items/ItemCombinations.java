...
import ethos.model.items.item_combinations.AvernicDefender;
...
import ethos.model.items.item_combinations.InfernalHarpoon;
...
import ethos.model.items.item_combinations.DragonPlatebody;
import ethos.model.items.item_combinations.DragonSkirt;
...
import ethos.model.items.item_combinations.DragonLegs;
...
public enum ItemCombinations {
	...
	DRAGON_PLATEBODY(new DragonPlatebody(new GameItem(21892), Optional.empty(), new GameItem[] { new GameItem(22097), new GameItem(22103), new GameItem(3140) })),
	...
	AVERNIC_DEFENDER(new AvernicDefender(new GameItem(22322), Optional.empty(), new GameItem[] { new GameItem(12954), new GameItem(22477) })),

	DEVOUT_BOOTS(new DevoutBoots(new GameItem(22954), Optional.empty(), new GameItem[] { new GameItem(12598), new GameItem(22960) })),
	...
	DRAGONLEGS(new DragonLegs(new GameItem(12415), Optional.empty(), new GameItem[] { new GameItem(12536), new GameItem(4087) })),
	
	DRAGONSKIRT(new DragonSkirt(new GameItem(12416), Optional.empty(), new GameItem[] { new GameItem(12536), new GameItem(4585) })),
